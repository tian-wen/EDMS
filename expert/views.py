...
class HomePageView(View):
    def get(self, request):
        ...
        ccn_experts = [
            {'cnn_number': 'A', 'cnn_name': '马克思主义、列宁主义、毛泽东思想、邓小平理论', 'experts': []},
            {'cnn_number': 'B', 'cnn_name': '哲学、宗教', 'experts': []},
            {'cnn_number': 'C', 'cnn_name': '社会科学总论', 'experts': []},
            {'cnn_number': 'D', 'cnn_name': '政治、法律', 'experts': []},
            {'cnn_number': 'E', 'cnn_name': '军事', 'experts': []},
            {'cnn_number': 'F', 'cnn_name': '经济', 'experts': []},
            {'cnn_number': 'G', 'cnn_name': '文化、科学、教育、体育', 'experts': []},
            {'cnn_number': 'H', 'cnn_name': '语言、文字', 'experts': []},
            {'cnn_number': 'I', 'cnn_name': '文学', 'experts': []},
            {'cnn_number': 'J', 'cnn_name': '艺术', 'experts': []},
            {'cnn_number': 'K', 'cnn_name': '历史、地理', 'experts': []},
            {'cnn_number': 'N', 'cnn_name': '自然科学总论', 'experts': []},
            {'cnn_number': 'O', 'cnn_name': '数理科学和化学', 'experts': []},
            {'cnn_number': 'P', 'cnn_name': '天文学、地球科学', 'experts': []},
            {'cnn_number': 'Q', 'cnn_name': '生物科学', 'experts': []},
            {'cnn_number': 'R', 'cnn_name': '医药、卫生', 'experts': []},
            {'cnn_number': 'S', 'cnn_name': '农业科学', 'experts': []},
            {'cnn_number': 'T', 'cnn_name': '工业技术', 'experts': []},
            {'cnn_number': 'U', 'cnn_name': '交通运输', 'experts': []},
            {'cnn_number': 'V', 'cnn_name': '航空、航天', 'experts': []},
            {'cnn_number': 'X', 'cnn_name': '环境科学、安全科学', 'experts': []},
            {'cnn_number': 'Z', 'cnn_name': '综合性图书', 'experts': []}
        ]
        ...
        for ccn_expert in ccn_experts:
            print(ccn_expert)
            date1 = datetime.now()
            # field_experts = InfluenceInfo.objects.filter(field=ccn_expert['cnn_number'], influ__gt=70)
            query_url = url_basic + "field:" + ccn_expert['cnn_number'] + "&fq=influ:[70 TO *]"
        ...
        result = {
            "cnn_experts": json.dumps(ccn_experts),
...
class ExpertDetailView(View):
    def get(self, request):
        ...
        if request.is_ajax():
            ...
            date2 = datetime.now()
            print("花费时间：" + str((date2-date1).seconds))
            result = {
